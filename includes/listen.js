module.exports = function({ api, models }) {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "This bot was made by Quốc Anh" : global.config.BOTNAME}`, "[ BOT INFO ]");
...
//THIZ BOT WAS MADE BY Quốc Anh - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
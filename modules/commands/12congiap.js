	...
	switch(event.body){
		...
		case "4":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/mẹo.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "5":
			api.sendMessage({
		...
		case "9":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/thân.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "10":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/dậu.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "11":
			api.sendMessage({
